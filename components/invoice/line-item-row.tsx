...
export function LineItemRow({ item, currency, canDelete, onUpdate, onDelete }: LineItemRowProps) {
  ...
  return (
    <div className="group grid grid-cols-[1fr_80px_100px_140px_32px] items-center gap-0 border-b border-border">
